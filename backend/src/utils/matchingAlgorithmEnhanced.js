 ...
 * 2. Écart d'âge optimal entre 5 et 10 ans
 * 3. Priorité au même service pour une meilleure compréhension du métier
 * 4. Charge de mentorat limitée (max 2 mentorés par mentor)
 */
...
const matchMentorMentee = (mentors, mentees) => {
    ...
    const calculateCompatibilityScore = (mentor, mentee) => {
        ...
        const ageDiff = Math.abs(mentor['Age du salarié en décembre 2024'] - mentee['Age du salarié en décembre 2024']);
    ...
    sortedMentees.forEach(mentee => {
        ...
        const eligibleMentors = mentors.filter(mentor => 
            ...
            Math.abs(mentor['Age du salarié en décembre 2024'] - mentee['Age du salarié en décembre 2024']) <= 10 && // Écart d'âge max 10 ans
        ...
        if (eligibleMentors.length > 0) {
            ...
            const match = {
                ...
                compatibilite: {
                    ...
                    ecartAge: Math.abs(selectedMentor['Age du salarié en décembre 2024'] - mentee['Age du salarié en décembre 2024'])
                }
            };
